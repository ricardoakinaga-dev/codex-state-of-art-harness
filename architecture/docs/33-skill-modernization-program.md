...
Local audit finds portability debt, optional missing references, duplicate `engineering-framework` and no causal host-load trace. These are program inputs, not permission to edit installed packages: [`skill-audit/reports/14-custom-skills-audit.md`](../../references/skill-audit/reports/14-custom-skills-audit.md), [`05-dependency-graph.md`](../../references/skill-audit/reports/05-dependency-graph.md).
