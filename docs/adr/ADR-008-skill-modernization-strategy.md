...
`docs/33-skill-modernization-program.md`, `docs/34-modernization-template.md`, `skill-audit/reports/18-priority-roadmap.md` e `skill-audit/reports/19-contracts.md`.
