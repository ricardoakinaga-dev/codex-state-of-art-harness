...
- `HARNESS-SPEC.md` e `docs/README.md`;
- `docs/00-vision.md` até `docs/44-final-documentation-report.md`;
- 10 ADRs em `docs/adr/`;
- 12 Mermaid diagrams em `docs/diagrams/`;
- 12 conceptual contracts em `docs/contracts/`;
- gauntlet bookkeeping em `.gauntlet/` e engineering process records em `.agent/`; estes não são runtime do harness.
